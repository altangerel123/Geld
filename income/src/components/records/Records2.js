    ...
    <div className="w-2/3">
      <div className="flex justify-between mb-[24px]">
        <div className="flex gap-[4px] items-center">
          <p className="w-[32px] h-[32px] bg-[#E5E7EB] flex justify-center items-center">{"<"}</p>
          <p>Last 30 Days</p>
          <p className="w-[32px] h-[32px] bg-[#E5E7EB] flex justify-center items-center">{">"}</p>
        </div>
        <div className="flex px-[16px] py-[4p] bg-white rounded-[8px] items-center">
          <p className=" text-[16px] font-normal leading-[24px]">Newest first</p>
          <img className="w-[20px] h-[20px] flex justify-center items-center" src="Icon3.png" />
        </div>
      </div>
  ...
  return (
    <div className="flex px-[24px] py-[12px] justify-between bg-white rounded-[12px]">
     <div className="flex leading-[24px] gap-[16px] items-center">
        <input className="w-[20px] h-[20px] border-[1px]" type={props.checkbox} />
        <img className="w-[40px] h-[40px] p-[5px] bg-[#FF4545] rounded-full" src={props.image} />
        <div className="flex flex-col">
          <p className="text-[16px] font-narmal">{props.title}</p>
          <p className="">{props.time}</p>
        </div>
      </div>
      <p className="text-[16px] font-normal leading-[24px] text-[#EAB308] flex items-center">{props.description}</p>
    </div>
  );
};
