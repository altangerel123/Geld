...
export default function Add() {
  ...
  // const [iconClick, setIconClick] = useState("none");
  // const handlClick = () => {
  //   setIconClick(!iconClick);
  // }
  return (
    <div style={{ display: add ? "none" : "flex" }}>
     <div className="w-full h-screen placeholder:h-screen flex justify-center items-center border-[1px] border-black">
      <div className="border-[1px] rounded-[10px] bg-white">
        <div className="flex justify-between border-b-[1px] p-[24px]">
          ...
          <button className="text-[20px] font-semibold leading-[28px]">X</button>   
        </div> 
        <div className="p-[24px]">
          <div className="flex gap-[12px] ">
            <div className="flex p-[16px] border-[1px] bg-[#F9FAFB] rounded-[8px]">
              <p className="w-[24px] h-[24px]"><FaHouse /></p>
  ...
  return(
    <div className="p-[24px] bg-white rounded-[8px]">
      <div className="grid grid-cols-6 p-[24px] gap-[24px]">
        <div><FaHouse/></div>
        <div><PiHouseLineFill/></div>
        <div><PiIdentificationBadgeFill/></div>
        <div><PiIdentificationCardFill/></div>
        <div><PiLadderBold/></div>
        <div><BsIntersect/></div>

        <div><FaRegImage/></div>
        <div><FaMagnifyingGlassPlus/></div>
        <div><FaMicrophone/></div>
        <div><SiMicrosoftexcel/></div>
        <div><PiNotepadFill/></div>
        <div><MdOutlinePlaylistPlay/></div>

        <div><RiLeafFill/></div>
        <div><PiNumberFiveFill/></div>
        <div><PiNumberSevenFill/></div>
        <div><PiRoadHorizonFill/></div>
        <div><PiHourglassSimpleMediumFill/></div>
        <div><RiAnchorLine/></div>

        <div><PiBezierCurveFill/></div>
        <div><PiExcludeFill/></div>
        <div><MdVignette/></div>
        <div><FaBaseballBall/></div>
        <div><FaQuestionCircle/></div>
        <div><PiExamFill/></div>

        <div>< PiWatchFill/></div>
        <div>< PiGlobeFill/></div>
        <div><PiOrangeSliceFill/></div>
        <div><PiPeaceFill/></div>
        <div><PiToiletPaperFill/></div>
        <div><FaPencilAlt/></div>
      </div>
